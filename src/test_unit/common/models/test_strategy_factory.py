...
class TestStrategyFactory:
    ...
    def test_init_invalid_strategy(self):
        ...
        with pytest.raises(Exception, match="Failed to validate strategy"):
    ...
    @patch(
        "common.models.strategy_factory.ALL_INVOCATION_TYPE_LIST",
    ...
    def test_initiate_strategy_class_not_found(self, mock_globals):
        ...
        with pytest.raises(
            Exception, match="Strategy class 'NonExistentStrategy' not found in globals"
        ):
            factory._initiate_strategy()
